...
public class BitmapTextureAtlasTextureRegionFactory {
	 ...
	 * @param pAssetManager
	 * @param pAssetSubdirectory to load all files from "inc.pashna.digitsincircles.gfx/flowers" put "flowers" here (assuming, that you've used {@link BitmapTextureAtlasTextureRegionFactory#setAssetBasePath(String)} with "inc.pashna.digitsincircles.gfx/" before.)
	 * @return
	 */
